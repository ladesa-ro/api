...
export class DisponibilidadeProfessorDiaEntity implements LadesaTypings.DisponibilidadeProfessorDia {
    ...
    disponibilidade!: LadesaTypings.DisponibilidadeProfessorFindOneResult;
