...
import { DisponibilidadeProfessorDiaEntity, DisponibilidadeProfessorEntity } from '@/adapters/adapter-database/typeorm/entities';
import { VinculoService } from '@/app-modules/autenticacao/vinculo/vinculo.service';
...
export class DisponibilidadeProfessorDiaService {
  ...
  async disponibilidadeProfessorDiaFindById(accessContext: AccessContext, dto: LadesaTypings.DisponibilidadeProfessorDiaFindOneInput, selection?: string[] | boolean): Promise<LadesaTypings.DisponibilidadeProfessorDiaFindOneResult | null> {
    // =========================================================
  ...
  async disponibilidadeProfessorDiaFindByIdSimple(accessContext: AccessContext, id: LadesaTypings.DisponibilidadeProfessorDiaFindOneInput['id'], selection?: string[]): Promise<LadesaTypings.DisponibilidadeProfessorDiaFindOneResult | null> {
    // =========================================================
  ...
  async disponibilidadeProfessorDiaCreate(accessContext: AccessContext, dto: LadesaTypings.DisponibilidadeProfessorDiaCreateCombinedInput) {
    ...
    return this.disponibilidadeProfessorDiaFindByIdStrict(accessContext, { id: disponibilidadeProfessorDia.id });
  }
  ...
  async disponibilidadeProfessorDiaUpdate(accessContext: AccessContext, dto: LadesaTypings.DisponibilidadeProfessorDiaUpdateByIDCombinedInput) {
    ...
    await accessContext.ensurePermission('disponibilidade_professor_dia:update', { dto }, dto.params.id, this.disponibilidadeProfessorDiaRepository.createQueryBuilder(aliasDisponibilidadeProfessorDia));
  ...
  async disponibilidadeProfessorDiaDeleteOneById(accessContext: AccessContext, dto: LadesaTypings.DisponibilidadeProfessorFindOneInput) {
    ...
    if (disponibilidadeProfessorDia) {
      await this.disponibilidadeProfessorDiaRepository
        ...
        .where('id = :disponibilidadeProfessorDiaId', { disponibilidadeProfessorDiaId: disponibilidadeProfessorDia.id })
