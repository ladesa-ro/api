...
import { TurmaService } from "@/business-logic/resources/ensino/turma/turma.service";
...
import type { TurmaDisponibilidadeEntity } from "@/infrastructure/adapters/adapter-database/typeorm/entities";
...
export class TurmaDisponibilidadeService {
  ...
  async turmaDisponibilidadeFindById(
    accessContext: AccessContext,
    dto: LadesaTypings.TurmaDisponibilidadeFindOneInput,
    selection?: string[] | boolean,
  ): Promise<LadesaTypings.TurmaDisponibilidadeFindOneResult | null> {
    // =========================================================
  ...
  async turmaDisponibilidadeFindByIdSimple(
    accessContext: AccessContext,
    id: LadesaTypings.TurmaDisponibilidadeFindOneInput["id"],
    selection?: string[],
  ): Promise<LadesaTypings.TurmaDisponibilidadeFindOneResult | null> {
    // =========================================================
