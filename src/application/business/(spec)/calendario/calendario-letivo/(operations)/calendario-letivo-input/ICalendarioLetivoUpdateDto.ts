...
export interface ICalendarioLetivoUpdateDto extends ICalendarioLetivoFindOneByIdInputDto, Partial<Pick<ICalendarioLetivoInputDto, 'nome' | 'ano' | 'campus' | 'modalidade'>> {}
