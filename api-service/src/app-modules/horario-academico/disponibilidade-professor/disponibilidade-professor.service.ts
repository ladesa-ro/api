...
import { DisponibilidadeProfessorEntity } from '@/adapters/adapter-database/typeorm/entities';
...
export class DisponibilidadeProfessorService {
  ...
  async disponibilidadeProfessorFindById(accessContext: AccessContext, dto: LadesaTypings.DisponibilidadeProfessorFindOneInput, selection?: string[] | boolean): Promise<LadesaTypings.DisponibilidadeProfessorFindOneResult | null> {
    // =========================================================
  ...
  async disponibilidadeProfessorFindByIdSimple(accessContext: AccessContext, id: LadesaTypings.DisponibilidadeProfessorFindOneInput['id'], selection?: string[]): Promise<LadesaTypings.DisponibilidadeProfessorFindOneResult | null> {
    // =========================================================
  ...
  async disponibilidadeProfessorCreate(accessContext: AccessContext, dto: LadesaTypings.DisponibilidadeProfessorCreateCombinedInput) {
    ...
    await accessContext.ensurePermission('disponibilidade_professor:create', { dto });
    ...
    return this.disponibilidadeProfessorFindByIdStrict(accessContext, { id: disponibilidadeProfessor.id });
  }
  ...
  async disponibilidadeProfessorDeleteOneById(accessContext: AccessContext, dto: LadesaTypings.DisponibilidadeProfessorFindOneInput) {
    ...
    if (disponibilidadeProfessor) {
      await this.disponibilidadeProfessorRepository
        ...
        .where('id = :disponibilidadeProfessorId', { disponibilidadeProfessorId: disponibilidadeProfessor.id })
