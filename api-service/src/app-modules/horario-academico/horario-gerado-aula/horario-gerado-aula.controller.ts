...
export class HorarioGeradoAulaController {
  ...
  async horarioGeradoAulaFindAll(@AccessContextHttp() clientAccess: AccessContext, @CombinedInput() dto: LadesaTypings.HorarioGeradoAulaListCombinedInput): Promise<LadesaTypings.HorarioGeradoAulaListCombinedSuccessOutput['body']> {
