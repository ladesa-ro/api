...
import { CalendarioLetivoService } from '@/app-modules/calendario/calendario-letivo/calendario-letivo.service';
import { HorarioGeradoEntity } from '@/adapters/adapter-database/typeorm/entities';
...
export class HorarioGeradoService {
  ...
  async horarioGeradoFindAll(
    ...
    await accessContext.aplicarFiltro('horario_gerado:find', qb, aliasHorarioGerado, null);
  ...
  async horarioGeradoCreate(accessContext: AccessContext, dto: LadesaTypings.HorarioGeradoCreateCombinedInput) {
    ...
    return this.horarioGeradoFindByIdStrict(accessContext, { id: horarioGerado.id });
  }
