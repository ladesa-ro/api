...
export class TurmaDisponibilidadeDiaController {
  ...
  async turmaDisponibilidadeDiaFindAll(@AccessContextHttp() clientAccess: AccessContext, @CombinedInput() dto: LadesaTypings.TurmaDisponibilidadeDiaListCombinedInput): Promise<LadesaTypings.TurmaDisponibilidadeDiaListCombinedSuccessOutput['body']> {
