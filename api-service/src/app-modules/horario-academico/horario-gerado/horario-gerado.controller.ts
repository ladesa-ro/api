...
export class HorarioGeradoController {
  ...
  async horarioGeradoFindAll(@AccessContextHttp() clientAccess: AccessContext, @CombinedInput() dto: LadesaTypings.HorarioGeradoListCombinedInput): Promise<LadesaTypings.HorarioGeradoListCombinedSuccessOutput['body']> {
  ...
  async horarioGeradoDeleteOneById(
    ...
    return this.horarioGeradoService.horarioGeradoDeleteOneById(accessContext, { id: dto.params.id });
  }
