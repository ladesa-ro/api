...
export class DiarioPreferenciaAgrupamentoController {
  ...
  async diarioPreferenciaAgrupamentoFindAll(@AccessContextHttp() clientAccess: AccessContext, @CombinedInput() dto: LadesaTypings.DiarioPreferenciaAgrupamentoListCombinedInput): Promise<LadesaTypings.DiarioPreferenciaAgrupamentoListCombinedSuccessOutput['body']> {
