...
import { DiarioPreferenciaAgrupamentoEntity } from '@/adapters/adapter-database/typeorm/entities';
import { IntervaloDeTempoService } from '@/app-modules/calendario/intervalo-de-tempo/intervalo-de-tempo.service';
import { DiarioService } from '@/app-modules/calendario/diario/diario.service';
...
export class DiarioPreferenciaAgrupamentoService {
  ...
  async diarioPreferenciaAgrupamentoFindById(accessContext: AccessContext, dto: LadesaTypings.DiarioPreferenciaAgrupamentoFindOneInput, selection?: string[] | boolean): Promise<LadesaTypings.DiarioPreferenciaAgrupamentoFindOneResult | null> {
    // =========================================================
    ...
    qb.andWhere(`${aliasDiarioPreferenciaAgrupamento}.id = :id`, { id: dto.id });
  ...
  async diarioPreferenciaAgrupamentoFindByIdSimple(accessContext: AccessContext, id: LadesaTypings.DiarioPreferenciaAgrupamentoFindOneInput['id'], selection?: string[]): Promise<LadesaTypings.DiarioPreferenciaAgrupamentoFindOneResult | null> {
    // =========================================================
  ...
  async diarioPreferenciaAgrupamentoCreate(accessContext: AccessContext, dto: LadesaTypings.DiarioPreferenciaAgrupamentoCreateCombinedInput) {
    ...
    return this.diarioPreferenciaAgrupamentoFindByIdStrict(accessContext, { id: diarioPreferenciaAgrupamento.id });
  }
  ...
  async diarioPreferenciaAgrupamentoUpdate(accessContext: AccessContext, dto: LadesaTypings.DiarioPreferenciaAgrupamentoUpdateByIDCombinedInput) {
    ...
    await accessContext.ensurePermission('diario_preferencia_agrupamento:update', { dto }, dto.params.id, this.diarioPreferenciaAgrupamentoRepository.createQueryBuilder(aliasDiarioPreferenciaAgrupamento));
  ...
  async diarioPreferenciaAgrupamentoDeleteOneById(accessContext: AccessContext, dto: LadesaTypings.DiarioPreferenciaAgrupamentoFindOneInput) {
    ...
    if (diarioPreferenciaAgrupamento) {
      await this.diarioPreferenciaAgrupamentoRepository
        ...
        .where('id = :diarioPreferenciaAgrupamentoId', { diarioPreferenciaAgrupamentoId: diarioPreferenciaAgrupamento.id })
