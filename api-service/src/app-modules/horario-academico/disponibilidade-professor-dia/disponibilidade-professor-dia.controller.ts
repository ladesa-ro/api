...
export class DisponibilidadeProfessorDiaController {
  ...
  async disponibilidadeProfessorDiaFindAll(@AccessContextHttp() clientAccess: AccessContext, @CombinedInput() dto: LadesaTypings.DisponibilidadeProfessorDiaListCombinedInput): Promise<LadesaTypings.DisponibilidadeProfessorDiaListCombinedSuccessOutput['body']> {
