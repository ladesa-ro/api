...
export class DisponibilidadeProfessorController {
  ...
  async disponibilidadeProfessorFindAll(@AccessContextHttp() clientAccess: AccessContext, @CombinedInput() dto: LadesaTypings.DisponibilidadeProfessorListCombinedInput): Promise<LadesaTypings.DisponibilidadeProfessorListCombinedSuccessOutput['body']> {
  ...
  async disponibilidadeProfessorFindById(
    ...
    @CombinedInput() dto: LadesaTypings.DisponibilidadeProfessorFindByIDCombinedInput,
  ) {
  ...
  async disponibilidadeProfessorCreate(
    //
    @AccessContextHttp() accessContext: AccessContext,
    @CombinedInput() dto: LadesaTypings.DisponibilidadeProfessorCreateCombinedInput,
  ) {
  ...
  async disponibilidadeProfessorUpdate(
    //
    @AccessContextHttp() accessContext: AccessContext,
    @CombinedInput() dto: LadesaTypings.DisponibilidadeProfessorUpdateByIDCombinedInput,
  ) {
  ...
  async disponibilidadeProfessorDeleteOneById(
    //
    @AccessContextHttp() accessContext: AccessContext,
    @CombinedInput() dto: LadesaTypings.DisponibilidadeProfessorDeleteByIDCombinedInput,
  ) {
