...
export class TurmaDisponibilidadeController {
  ...
  async turmaDisponibilidadeFindAll(@AccessContextHttp() clientAccess: AccessContext, @CombinedInput() dto: LadesaTypings.TurmaDisponibilidadeListCombinedInput): Promise<LadesaTypings.TurmaDisponibilidadeListCombinedSuccessOutput['body']> {
  ...
  async turmaDisponibilidadeFindById(
    ...
    @CombinedInput() dto: LadesaTypings.TurmaDisponibilidadeFindByIDCombinedInput,
  ) {
  ...
  async turmaDisponibilidadeUpdate(
    //
    @AccessContextHttp() accessContext: AccessContext,
    @CombinedInput() dto: LadesaTypings.TurmaDisponibilidadeUpdateByIDCombinedInput,
  ) {
  ...
  async turmaDisponibilidadeDeleteOneById(
    //
    @AccessContextHttp() accessContext: AccessContext,
    @CombinedInput() dto: LadesaTypings.TurmaDisponibilidadeDeleteByIDCombinedInput,
  ) {
